...
export default function FundDetails({ fund, allCompanyData }: Props) {
  ...
  // Placeholder: replace with real fund holdings (e.g., by ISIN list)
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6 sm:p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-2xl font-bold text-gray-900">{fund.fundName}</h3>
          ...
          <tbody>
            {rows.map((company, index) => (
              <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td className="p-2 text-center">{formatNumber(company.composite ?? 0)}</td>

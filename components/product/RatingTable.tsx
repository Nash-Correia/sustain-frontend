...
export default function RatingTable(p: Props) {
  ...
  return (
    <div className="pt-4 sm:pt-6">
      <div className="rounded-[14px] border border-gray-300 bg-white shadow-sm overflow-visible">
        {/* ====================== TABLE HEADER ====================== */}
        <div className="grid grid-cols-[1.2fr_1fr_.6fr_.6fr] items-center px-4 sm:px-6 h-14 rounded-t-[14px] border-b border-gray-200 text-[15px] font-semibold text-[#1C6C6C] overflow-visible">
        ...
        <ul className="divide-y divide-gray-200">
          ...
          {Array.from({ length: fillerCount }).map((_, i) => (
            <li key={`filler-${i}`} className={`grid grid-cols-[1.2fr_1fr_.6fr_.6fr] px-4 sm:px-6 ${ROW_H}`}>
              <div />
              <div />
              <div />
              <div />

    ...
    <InfoSection id="social" title="Social Pillar">
      ...
      <div className="mt-8 grid lg:grid-cols-1 gap-8">
        ...
        <InfoCard icon={<DiversityIcon />} title="Workforce Diversity">
          ...
          <ul className="list-disc list-inside space-y-2 mt-4">
            <li><strong>Aspirational Goals:</strong> IiAS believes companies should aspire to have at least <strong className="text-blue-700">30% representation of women</strong> in their total workforce and among Key Managerial Personnel (KMP).</li>
